...
const title = route.meta?.title || 'Project Type'
...
const { tableItems, rawKeys, headers } = useTableData(types, transformConfig)
...
<template>
  <div class="card">
    <div class="card-body">
      <h5 class="card-title fw-medium mb-4">List Project Types</h5>
