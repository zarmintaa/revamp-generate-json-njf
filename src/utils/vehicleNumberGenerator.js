...
export function mapToFormData(pkVehicleData, additionalFields = {}) {
  ...
  const defaultFormData = {
    ...
    FUND_OBJT_TYPE: 'SEDAN',
    FUND_CARA_PEMBIAYAAN: 'KREDIT',
    FUND_KEGIATAN_USAHA: 'PERDAGANGAN',
    ...
    LTV: null,
    FUND_MKPP_ID: '',
    FUND_OBJT_ENGINE_CAPACITY: '',
    FUND_OBJT_DOC: '',
    FUND_OBJT_MODEL: '',
    FUND_CUST_OWNER_NAME: '',
    FUND_CUST_OWNER_KTP_NO: '',
    FUND_CUST_OWNER_NPWP_NO: '',
    FUND_OBJT_PROD_YEAR: '',
    FUND_OBJT_PURPOSE: '',
    FUND_OBJT_YEAR: '',
    FUND_OLD_CONT_NO: '',
